---
name: compose-photo-memory-editorial
description: Compose a clean vertical editorial artwork that preserves an uploaded photograph as the original image and pairs it with a restrained, photo-derived abstract memory panel and poetic English title. Use when asked for a photo-and-abstraction diptych, visual memory panel, minimalist archival poster, or editorial composition that must keep the source photo faithful.
---

# Compose Photo Memory Editorial
...
- Chinese: [references/compose-photo-memory-editorial-prompt.zh-CN.md](references/compose-photo-memory-editorial-prompt.zh-CN.md)
- English: [references/compose-photo-memory-editorial-prompt.en.md](references/compose-photo-memory-editorial-prompt.en.md)
